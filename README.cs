...
public static class GuiCommandFactory
{
    ...
    public const string SetHvacDisplayModeCommand = "CMD_HVAC_SET_DISPLAY_MODE";
    ...
    public static string CreateStringPayload(string key, string value)
    {
        return "{\""
            + EscapeJson(key)
            + "\":\""
    ...
    public static string CreateHvacDisplayModePayload(string mode)
    {
        string safeMode = string.IsNullOrEmpty(mode)
            ? HvacDisplayModeOn
            : mode;

        return CreateStringPayload("mode", safeMode);
    }
    ...
    public static string CreateHvacVibrationPatternPayload(string pattern)
    {
        ...
        return CreateStringPayload("pattern", safePattern);
    }
